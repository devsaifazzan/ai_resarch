...
async def chat(request: ChatRequest):
    try:
        ...
        llm = ChatGoogleGenerativeAI(temperature=0, model="gemini-pro", google_api_key=request.api_key)
...
async def generate_presentation(request: ChatRequest):
    try:
        ...
        llm = ChatGoogleGenerativeAI(temperature=0.2, model="gemini-pro", google_api_key=request.api_key)
